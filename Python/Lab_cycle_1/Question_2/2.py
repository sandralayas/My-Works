...
print(' The first triangle  :\n')# Reads and prints the 1st triangle
a,b,c=read_side()
t1=area(a,b,c)
print(' The area fo the 1st triangle : ',t1,'\n')

print(' The second triangle :\n')# Reads and prints the 2st triangle
x,y,z=read_side()
t2=area(x,y,z)
print(' The area fo the 2nd triangle : ',t2,'\n')

print(' Total area = ',t1+t2)# Total area
print('\n Persentage of the first triangle   = ',t1/(t1+t2)*100,'%')# % of 1st triangle
print('\n Persentage of the second triangle  = ',t2/(t1+t2)*100,'%')# % of 2st triangle
